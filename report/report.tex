...
A Bloom Filter supports two primary operations: inserting an element and querying whether an element is in a set. It 
provides space-efficient membership testing at the cost of allowing false positives.
